...
4)   Update Order - Stretch Goal - Incomplete
5)   Delete Order
6)   Exit App
        ''')
...
def update_order_status():
    ...
    print(df)
    # update_order_name = input("Please enter the customer name of the order you wish to update...")
#     with open("orders.csv", 'r') as file:
#         csv_file = csv.DictReader(file) 
#         for info in csv_file:
#             if (info["Name"] == update_order_name):
#                 info["Status"] = "Delivered"
#                 with open('orders.csv', 'w') as writeFile:
#                     writer = csv.writer(writeFile)
#                     writer.writerows(orders)
#             else:
#                 print("The customer you entered does not exist in the system.")
#                 return_option("Orders")  
#     util.clear_terminal()
#     header("Updated Order Menu")
#     df = pandas.read_csv('orders.csv', index_col=0)
#     print(df)
#     return_option("Orders")                
...
def delete_order():
    ...
    df = pandas.read_csv('orders.csv', index_col=0)
    print(df) 
    delete_name = input('Please enter the customer name for the order to delete..')
...
#         information = ['Name', 'Customer_Address', 'Customer_Number', 'Courier', 'Status', 'Order']
...
Peter Rabbit,12 The Burrow,0123456,T.B.C.,Preparing,Pepperoni Pizza
George Foreman,18 The Grill,345678,T.B.C.,Preparing,Sorbet
Harry Potter,4 Privet Drive,123845,T.B.C.,Preparing,Nachos
James Peters,123 Anywhere,01234567,T.B.C.,Preparing,Coke, Nachos
